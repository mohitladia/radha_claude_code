...
def show_task_status() -> None:
    ...
    Fetches the most recent approved project from the DB, then displays:
    - Project ID and progress summary
    - Table with: #, ID, Type, Title, Status (colored), Retries, Error
    """
